...
ROBOT_XML_DICT = {
    ...
    "unitree_g1_23dof": ASSET_ROOT / "unitree_g1" / "g1_23dof.xml",
    ...
    "robros_igris_c_v2": ASSET_ROOT / "robros_igris_c_v2" / "igris_c_v2.xml",
    "robros_igris_max": ASSET_ROOT / "robros_igris_max" / "igris_max.xml",
}
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "robros_igris_c_v2": IK_CONFIG_ROOT / "smplx_to_igris_c.json", # smplx_to_igris_c_2, smplx_to_igris_c_tmp, smplx_to_igris_c_kimodo
    ...
    "bvh_lafan1":{
        ...
        "robros_igris_c_v2": IK_CONFIG_ROOT / "bvh_lafan1_to_igris_c.json",
    },
    "fbx":{
    ...
    "xrobot":{
        ...
        "robros_igris_c_v2": IK_CONFIG_ROOT / "xrobot_to_igris_c.json", #xrobot_to_igris_c_2
    },
    "xsens_mvn": {
...
ROBOT_BASE_DICT = {
    ...
    "tienkung": "Base_link",
    "robros_igris_c_v2": "base_link",
    "robros_igris_max": "Pelvis",
}
...
VIEWER_CAM_DISTANCE_DICT = {
    ...
    "pnd_adam_lite": 3.0,
    "tienkung": 3.0,
    "robros_igris_c_v2": 3.0,
    "robros_igris_max": 3.0,
}
